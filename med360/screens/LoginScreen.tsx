...
const LoginScreen = ({ navigation }: any) => {
  ...
  const register = async () => {
    ...
    if (!name || !age || !gender || !address || !phone || !password || !confirmPassword) {
  ...
  const login = async () => {
    ...
    try {
      ...
      if (data.role === "patient") {
        navigation.navigate("PatientDashboard", { patientName: data.name });
      } else if (data.role === "doctor") {
        navigation.navigate("DoctorDashboard", { doctorName: data.name });
      } else {
    ...
    >
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.tabWrapper}>
          ...
          >
            <Text style={tab === "login" ? styles.activeText : styles.tabText}>Login</Text>
          </TouchableOpacity>
          ...
          >
            <Text style={tab === "register" ? styles.activeText : styles.tabText}>Register</Text>
          </TouchableOpacity>
        </View>
          ...
          {tab === "register" && (
            <>
              ...
              <View style={{ flexDirection: 'row', gap: 10 }}>
                ...
                <View style={{ flex: 1 }}>
                   <Input label="Gender" value={gender} onChange={setGender} placeholder="M / F / Other" />
                </View>
              </View>
...
/* ---------------- SMALL COMPONENTS ---------------- */
const Input = ({ label, value, onChange, secure, keyboard, placeholder }: any) => {
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: "#fff", marginHorizontal: 20, borderRadius: 24, padding: 22, elevation: 6, marginBottom: 30 },
  ...
  inputField: { flex: 1, paddingVertical: 10, fontSize: 16, color: '#1E293B' },
